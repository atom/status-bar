...
class CursorPositionView {
  ...
  destroy() {
    ...
    if (this.cursorSubscription != null) this.cursorSubscription.dispose()
    this.tooltip.dispose()
    if (this.configSubscription != null) this.configSubscription.dispose()
    this.clickSubscription.dispose()
    if (this.updateSubscription != null) this.updateSubscription.dispose()
  }
