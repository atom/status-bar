...
export default SelectionCountView = class SelectionCountView {
  ...
  subscribeToActiveTextEditor() {
    ...
    const selectionsMarkerLayer = activeEditor ? activeEditor.selectionsMarkerLayer : undefined;
    this.selectionSubscription = selectionsMarkerLayer ? selectionsMarkerLayer.onDidUpdate(this.scheduleUpdateCount.bind(this)) : undefined;
    this.scheduleUpdateCount();
  }
