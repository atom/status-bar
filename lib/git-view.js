...
export default GitView = class GitView {
  ...
  destroy() {
    ...
    if (this.commitsAheadTooltipDisposable) {
      this.commitsAheadTooltipDisposable.dispose();
    }
    if (this.commitsBehindTooltipDisposable) {
      this.commitsBehindTooltipDisposable.dispose();
    }
    this.statusTooltipDisposable ? this.statusTooltipDisposable.dispose() : undefined;
  }
  ...
  updateTooltipText(text) {
    if (this.statusTooltipDisposable) {
