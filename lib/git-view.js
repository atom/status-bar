...
class GitView {
  ...
  subscribeToActiveItem() {
    ...
    if (this.savedSubscription != null) this.savedSubscription.dispose()
  ...
  subscribeToRepositories() {
    if (this.repositorySubscriptions != null) this.repositorySubscriptions.dispose()
  ...
  destroy() {
    if (this.activeItemSubscription != null) this.activeItemSubscription.dispose()
    if (this.projectPathSubscription != null) this.projectPathSubscription.dispose()
    if (this.savedSubscription != null) this.savedSubscription.dispose()
    if (this.repositorySubscriptions != null) this.repositorySubscriptions.dispose()
    if (this.branchTooltipDisposable != null) this.branchTooltipDisposable.dispose()
    if (this.commitsAheadTooltipDisposable != null) this.commitsAheadTooltipDisposable.dispose()
    if (this.commitsBehindTooltipDisposable != null) this.commitsBehindTooltipDisposable.dispose()
    if (this.statusTooltipDisposable != null) this.statusTooltipDisposable.dispose()
  }

  getActiveItemPath() {
    const activeItem = this.getActiveItem()
    return activeItem && typeof activeItem === 'function' && activeItem().getPath()
  }
  ...
  updateStatusText(repo) {
    ...
    if (this.showGitInformation(repo) && (itemPath != null)) {
      ...
      if (repo.isStatusNew(status)) this.updateAsNewFile()
      if (repo.isStatusModified(status)) this.updateAsModifiedFile(repo, itemPath)
