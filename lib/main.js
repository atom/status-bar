...
module.exports = {
  ...
  deactivate() {
    if (this.statusBarVisibilitySubscription != null) this.statusBarVisibilitySubscription.dispose()
    this.statusBarVisibilitySubscription = null

    if (this.gitInfo != null) this.gitInfo.destroy()
    this.gitInfo = null

    if (this.fileInfo != null) this.fileInfo.destroy()
    this.fileInfo = null

    if (this.cursorPosition != null) this.cursorPosition.destroy()
    this.cursorPosition = null

    if (this.selectionCount != null) this.selectionCount.destroy()
    ...
    if (this.emitters != null) this.emitters.dispose()
    this.emitters = null
  },
