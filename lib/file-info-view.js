...
class FileInfoView {
  ...
  clearCopiedTooltip() {
    if (this.copiedTooltip != null) this.copiedTooltip.dispose()
    this.registerTooltip()
  }
  ...
  subscribeToActiveItem() {
    if (this.modifiedSubscription != null) this.modifiedSubscription.dispose()
    if (this.titleSubscription != null) this.titleSubscription.dispose()
  ...
  destroy() {
    ...
    if (this.titleSubscription != null) this.titleSubscription.dispose()
    if (this.modifiedSubscription != null) this.modifiedSubscription.dispose()
    if (this.clickSubscription != null) this.clickSubscription.dispose()
    if (this.copiedTooltip != null) this.copiedTooltip.dispose()
    if (this.tooltip != null) this.tooltip.dispose()
  }
